...
public class LineCollisionDetector : MonoBehaviour
{
    ...
    [Header("控制对象")]
    public GameObject navBox;              // 默认显示的对象
    public GameObject navBoxf;              // 碰撞时显示的对象
    ...
    private void OnCollisionEnter()
    {
        ...
        // 关闭ObjectA，打开ObjectB
        if (navBox != null)
            navBox.SetActive(false);

        if (navBoxf != null)
            navBoxf.SetActive(true);
    }
    ...
    private void OnCollisionExit()
    {
        ...
        // 关闭ObjectB，打开ObjectA
        if (navBoxf != null)
            navBoxf.SetActive(false);

        if (navBox != null)
            navBox.SetActive(true);
    }
